    ...
    return {
        ...
        execute: function() {
            DetailsService = (function () {
                ...
                DetailsService.prototype.getOrderDetails = function (ordid) {
                    return this.http.get('http://localhost:8000/api/getorderdetails/' + ordid);
                };
                DetailsService.prototype.getUserById = function (id) {
                    return this.http.get('http://localhost:8000/api/user/' + id);
                };
                DetailsService.prototype.getPrecDetails = function (preid) {
